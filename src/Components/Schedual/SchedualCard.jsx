...
export const SchedualCard = ({item}) => {
  return (
    <Box fontFamily="BentonSans-Bold,Arial,Noto Sans,sans-serif" mt = "10px" >
        <Box  w="310px" h="150px" m ="auto" p="8px" borderRadius="10px" backgroundColor="white" color="black">
            <Box>
                <Text textAlign="left" fontSize="10px"><span style = {{ color:"#E44242",fontWeight:"bold" }}>{item.status}</span> <span style = {{ color:"#48494A",fontWeight:"medium" }}> •  {item.legue}</span>   <span style = {{ color:"#48494A"}}> •  {item.place}</span></Text>
            </Box>
            <Box m = "8px 0px">
